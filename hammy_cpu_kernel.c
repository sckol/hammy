...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // void()(unsigned long long, unsigned long long *, long long)
/*  1 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 12), // unsigned long long
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 1), // unsigned long long *
/*  3 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 11), // long long
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

static void _cffi_d_run(unsigned long long x0, unsigned long long * x1, long long x2)
{
  run(x0, x1, x2);
}
#ifndef PYPY_VERSION
...
_cffi_f_run(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "run", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "run", (void *)_cffi_f_run, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_run },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_hammy_cpu_kernel(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_hammy_cpu_kernel(void) { return NULL; }
#  else
     inithammy_cpu_kernel(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_hammy_cpu_kernel(void)
{
  return _cffi_init("hammy_cpu_kernel", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inithammy_cpu_kernel(void)
{
  _cffi_init("hammy_cpu_kernel", 0x2601, &_cffi_type_context);
}
#endif
